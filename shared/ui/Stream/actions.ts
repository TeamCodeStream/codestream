...
import { AppDispatch, CodeStreamState } from "../store";
...
export const setUserPreference = createAsyncThunk<void,
    SetUserPreferenceRequest,
    { dispatch: AppDispatch }>("stream/setUserPreferences", async (request, {dispatch}) => {
